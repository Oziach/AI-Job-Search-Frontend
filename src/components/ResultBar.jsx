...
const ResultBar = ({ index, job }) => {
  ...
  return (
    <div className="w-4/5 sm:w-3/4 lg:w-3/5 px-2">
      {/* The bar itself */}
      <div className="w-full h-12 grid grid-cols-[3fr_10fr_2.5fr_0.5fr] items-center border-t border-gray-500 gap-4">
        ...
        <div
          ...
          className="flex items-center justify-center border-2 border-gray-200 rounded-md px-2 py-1 hover:cursor-pointer"
        >
          <img
            src={dropdown_icon}
            className={`brightness-25 h-4 ${
